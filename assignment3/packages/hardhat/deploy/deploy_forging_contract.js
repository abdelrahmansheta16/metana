...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  const MyERC1155Contract = await ethers.getContract("MyERC1155Token");

  await deploy("ForgingContract", {
    // Learn more about args here: https://www.npmjs.com/package/hardhat-deploy#deploymentsdeploy
    from: deployer,
    args: [MyERC1155Contract.address],
    log: true,
  });

  const forgingContract = await ethers.getContract("ForgingContract");
...
module.exports.tags = ["ForgingContract"];
